<template>
  <a-form :form="form" :colon="false" labelAlign="left">
    ...
    <a-form-item label="字体颜色" :labelCol="{ span: 5 }" :wrapperCol="{ span: 18 }">
      <color-input :show-input="true" :elId="'timeFontColor'" v-decorator="['color', { initialValue: formData.color }]"></color-input>
    </a-form-item>
    <a-form-item label="背景颜色" :labelCol="{ span: 5 }" :wrapperCol="{ span: 18 }">
      <color-input :show-input="true" :elId="'timeBgColor'" v-decorator="['backgroundColor', { initialValue: formData.backgroundColor }]"></color-input>
    </a-form-item>
