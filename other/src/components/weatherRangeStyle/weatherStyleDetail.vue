  ...
  <div>
    <a-form :form="form" :colon="false" labelAlign="left">
      ...
      <a-form-item label="字体颜色" :labelCol="{ span: 5 }" :wrapperCol="{ span: 18 }">
        <color-input
          :show-input="true"
          :elId="'weatherFontColor'"
          v-decorator="['color', { initialValue: formData.color }]"
        ></color-input>
      </a-form-item>
      <a-form-item label="背景设置" :labelCol="{ span: 5 }" :wrapperCol="{ span: 18 }">
        <a-radio-group v-decorator="['bgType', { initialValue: formData.bgType }]">
          <a-radio value="0">纯色</a-radio>
          <a-radio value="1">图片</a-radio>
        </a-radio-group>
      </a-form-item>
      <a-form-item label="背景色" :labelCol="{ span: 5 }"  :wrapperCol="{ span: 18 }" v-if="formData.bgType==='0'">
        <color-input
          :elId="'weatherBgColor'"
          :show-input="true"
          v-decorator="['bgColor', { initialValue: formData.bgColor }]"
        ></color-input>
      </a-form-item>
      <a-form-item
        label="背景图"
      ...
      <!-- <a-form-item label="背景颜色" :labelCol="{ span: 5 }" :wrapperCol="{ span: 18 }">
      <color-input :show-input="true" :elId="'weatherBgColor'" v-decorator="['backgroundColor', { initialValue: formData.backgroundColor }]"></color-input>
      </a-form-item>-->
    </a-form>
...
export default {
  ...
  methods: {
    ...
    uploadFile(pramas) {
     ...
     choose(data) {
      this.formData.bgImg = data.materialContent;
      this.form.setFieldsValue({
        bgImg: data.materialContent,
        ...this.formData
      });
      this.visible = false;
    }
